    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-gray-100 border border-gray-200 rounded-3xl p-6 flex flex-col justify-between gap-5">
          ...
          <div className="w-full rounded-2xl border border-orange-200 bg-white px-4 py-3.5 shadow-sm"><div className="flex items-start gap-3"><div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-orange-50 text-orange-600"><Pin className="h-4 w-4" aria-hidden="true" /></div><div className="min-w-0"><p className="text-[12px] font-extrabold leading-snug text-gray-900">Order multiple products together — add each item to your Basket, then checkout once.</p><p lang="si" className="mt-1.5 text-[12px] font-extrabold leading-[1.7] text-gray-800" style={{fontFamily:"'Noto Sans Sinhala', sans-serif"}}>භාණ්ඩ කිහිපයක් එකවර ඇණවුම් කළ හැක. අවශ්‍ය භාණ්ඩ Basket එකට එක් කර අවසානයේ එක්වර Checkout කරන්න.</p></div></div></div>
        </div>
      </div>
