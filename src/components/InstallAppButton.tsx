  ...
  return (
    <div className="relative">
      <button
        ...
        onClick={install}
        className={compact
          ? 'inline-flex items-center gap-1 rounded-full border border-orange-200 bg-orange-50 px-2 py-2 text-[11px] font-black text-orange-800 hover:bg-orange-100'
      ...
      >
        ...
        <span className={compact ? 'hidden min-[400px]:inline' : ''}>{compact ? 'Install' : 'Install App'}</span>
      </button>
