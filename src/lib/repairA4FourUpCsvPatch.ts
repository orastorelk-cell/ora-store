 ...
 * CSV feed the existing A4 4-up renderer, so four repaired A6 invoices can be
 * printed on one A4 sheet without changing the Invoice V6 layout.
 */
