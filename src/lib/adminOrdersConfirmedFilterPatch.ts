...
export const adminOrdersConfirmedFilterPatch = (): Plugin => ({
  ...
  transform(code, rawId) {
    ...
    const stateNew = "  // ADMIN ORDERS CONFIRMED FILTER\n  const [orderFilter, setOrderFilter] = useState<OrderStatus | 'All' | 'Confirmed'>('All');";
    ...
    const buttonsNew = "['All', 'New Orders', 'Confirmed', 'Processing', 'Packed', 'Shipped', 'Delivered', 'Cancelled']";
