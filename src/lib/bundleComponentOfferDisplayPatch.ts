...
/**
 * Storefront-only Combo Pack offer display.
 *
 * The combo customer/payable price is intentionally untouched. Only the crossed
 * reference price and saving badge are derived from the exact component items.
 */
